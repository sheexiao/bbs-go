...
export default {
  ...
  data() {
    return {
      content: '',
      images: [
        // 'http://localhost:3000/images/2020/02/27/0aadf3d7c46dba756f4e228e8e8f8ed6.jpg?id=1'
        // 'http://localhost:3000/images/2020/02/28/6819d3e0afb535594fb55c1108e1ad37.jpg'
      ],
      message: '',
      maxWordCount: 128,
      showUploader: false,
